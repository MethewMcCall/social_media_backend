...
SECRET_KEY = 'django-insecure-u57!79^9yum+x4cnwdd@f@v#sbjmsy=f5)0%%jo0l%s@zjddsy'
...
REST_KNOX = {
    ...
    'USER_SERIALIZER': 'socialapp.serializers.UserSerializer',  # Changed from social_app to socialapp
